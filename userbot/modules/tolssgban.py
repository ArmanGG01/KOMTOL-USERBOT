...
async def gben(userbot):
    ...
    await dark.edit("`Global Banned Akan Segera Aktif, Blok!!!`")
    ...
    if user:
        if user.id in DEVS:
            return await dark.edit("`LU GABISA GBAN HACKER, DIA YANG BIKIN GUA KONTOL`")
        try:
        ...
        for i in testuserbot:
            try:
                ...
                a += 1
                await dark.edit("`Global Banned Aktif ya Blok✅`")
            except BaseException:
                b += 1
    else:
        await dark.edit("`Reply pesan dulu ngentot!!`")
    try:
...
async def gunben(userbot):
    ...
    if user:
        if user.id in DEVS:
            return await dark.edit("**LU GABISA BLACKLIST HACKER, DIA YG BIKIN GUA KONTOL**")
        try:
        ...
        for i in testuserbot:
            try:
                ...
                a += 1
                await dark.edit("`Cancel Global Banned... Memproses... `")
            except BaseException:
                b += 1
    else:
