...
@register(outgoing=True, pattern=r"^.setfilter (.*)")
...
@register(outgoing=True, pattern=r"^.rfilter (.*)")
...
@register(outgoing=True, pattern="^.getfilter$")
...
CMD_HELP.update({
    ...
    \n\n`.setfilter` <keyword> <balasan> atau balas ke pesan ketik .filter <keyword>\
