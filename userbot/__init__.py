...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/ArmanGG01/KONTOL-USERBOT")
UPSTREAM_REPO_BRANCH = os.environ.get(
    "UPSTREAM_REPO_BRANCH", "KONTOL-USERBOT")
...
VEGETA_TEKS_KOSTUM = os.environ.get("KONTOL_TEKS_KOSTUM") or "ㅤ"

# Untuk Melihat Repo
REPO_NAME = os.environ.get("REPO_NAME") or "KONTOL-USERBOT"
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "KONTOL-USERBOT")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/663c676d584b166c27c6d.jpg"

# Default .helpme logo
HELP_LOGO = os.environ.get(
   "HELP_LOGO") or "https://telegra.ph/file/663c676d584b166c27c6d.jpg"
...
DEFAULT_BIO = os.environ.get("DEFAULT_BIO") or "KONTOL-USERBOT"
...
BOTLOG_MSG = os.environ.get(
    "BOTLOG_MSG") or "```║KONTOL-UBOT TELAH AKTIF🌈║\n\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\nJika Tidak Bisa Di .ping\nSilahkan Anda\nCek viewlogs\nPada heroku Anda.\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰```"
...
#Import Userbot - Ported by Arman
from userbot import (
    ALIVE_NAME
)
...
with bot:
    try:
        ...
        async def opeen(event):
            try:
                ...
                if tgbotusername is not None:
                    results = await event.client.inline_query(tgbotusername, "@kontolis_bot")
        ...
        async def inline_handler(event):
            ...
            result = None
            query = event.text
            if event.query.user_id == uid and query.startswith("@kontolis_bot"):
                buttons = paginate_help(0, dugmeler, "helpme")
                result = builder.photo(
                    file=ramlogo,
                    link_preview=False,
                    text=f"☄️KONTOL-UBOT☄️​\n\n**Mᴀɪɴ Mᴇɴᴜ​**\n\n❥ **ʙᴏᴛ ᴏꜰ :** {DEFAULTUSER}\n❥ **ʙᴏᴛ ᴠᴇʀ :** 7.1\n❥ **ᴍᴏᴅᴜʟᴇꜱ :** {len(plugins)}\n❥ **ᴅᴇᴠᴇʟᴏᴘᴇʀ​ :** [{DEFAULTUSER}]({OWNER_BOT}) ".format(
                        len(dugmeler),
                    ),
                    buttons=buttons,
                )
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:  # @kontolis_bot
                # https://t.me/TelethonChat/115200
                await event.edit(
                    file=ramlogo,
                    link_preview=True,
